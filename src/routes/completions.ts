...
export class CS571AICompletionsRoute implements CS571Route {
    ...
    private readonly connector: CS571HW11AIDbConnector;
    private readonly publicConfig: HW11AIPublicConfig;
    private readonly secretConfig: HW11AISecretConfig;

    public constructor(connector: CS571HW11AIDbConnector, publicConfig: HW11AIPublicConfig, secretConfig: HW11AISecretConfig) {
